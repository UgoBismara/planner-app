...
export const RECIPES = [
  ...
  },
  {
    ...
    calories: 330,
    ingredients: [
      "2 pavés de saumon (crus, ~150g chacun)",
      "1 citron",
      "Aneth",
      "1 courgette",
  ...
  },
  {
    ...
    calories: 640,
    ingredients: [
      "400g de viande hachée (crue)",
      "1 oignon",
      "2 carottes",
      "Sauce tomate",
      "Vin rouge",
      "400g de spaghetti (crus)",
      "Parmesan",
    ],
    steps: [
  ...
  },
  {
    ...
    ingredients: [
      ...
      "Parmesan",
      "Anchois",
      "Sauce César (yaourt, citron, ail, moutarde)",
    ],
    steps: [
  ...
  },
  {
    ...
    calories: 630,
    ingredients: [
      "300g de lentilles vertes du Puy (crues)",
  ...
  },
  {
    ...
    calories: 430,
    ingredients: [
      "Pâte à pizza (ou achetée)",
      "Sauce tomate",
      "Mozzarella",
      "Garnitures au choix (jambon, champignons, poivrons)",
      "Origan",
    ],
    steps: [
...

  {
    ...
    ingredients: [
      ...
      "160g de blanc de dinde (cru)",
      "200g de brocolis (ou courgettes)",
  ...
  },
  {
    ...
    calories: 350,
    ingredients: [
      "250g de lentilles corail (crues)",
  ...
  },
  {
    ...
    calories: 335,
    ingredients: [
      "500g de viande hachée crue (bœuf ou agneau)",
  ...
  },
  {
    ...
    calories: 560,
    ingredients: [
      "800g de cuisses de poulet (crues)",
      "200g de semoule (crue)",
      "2 carottes",
      "2 courgettes",
      "1 boîte de pois chiches",
  ...
  },
  {
    ...
    calories: 355,
    ingredients: [
      "500g de viande hachée d'agneau (crue)",
      "2 aubergines",
      "1 boîte de tomates concassées",
      "1 oignon",
      "Cannelle",
  ...
  },
  {
    ...
    calories: 270,
    ingredients: [
      "600g de viande hachée crue (bœuf + porc)",
      "2 œufs",
      "50g de chapelure",
      "1 oignon",
      "2 gousses d'ail",
  ...
  },
  {
    ...
    ingredients: [
      ...
      "Quelques framboises",
      "1 c.s. de miel",
      "1 c.s. de beurre d'amande (optionnel)",
    ],
    steps: [
  ...
  },
  {
    ...
    calories: 460,
    ingredients: [
      "4 tranches de brioche ou pain rassis",
      "2 œufs",
      "100ml de lait",
      "1 c.s. de sucre",
      "1 c.c. de cannelle",
  ...
  },
  {
    ...
    ingredients: [
      ...
      "1 c.s. de miel",
      "Fruits de saison (fraises, myrtilles, pêche)",
      "Quelques noix",
    ],
    steps: [
  ...
  },
  {
    ...
    ingredients: [
      ...
      "2 c.s. de miel",
      "1 c.s. de graines de chia",
      "1 c.s. de pépites de chocolat noir",
    ],
    steps: [
  ...
  },
  {
    ...
    ingredients: [
      ...
      "5 dattes ou quelques raisins secs",
    ],
    steps: [
  ...
  },
  {
    ...
    ingredients: [
      ...
      "30g de beurre fondu",
      "Garniture au choix : Nutella, confiture, citron-sucre",
    ],
    steps: [
...

  {
    ...
    calories: 560,
    ingredients: [
      "300g de pâtes crues (penne ou rigatoni)",
